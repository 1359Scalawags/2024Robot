...
public class AutoCommunity1Command extends Command {
     ...
     * @param isOpenLoop
     */
    public AutoCommunity1Command(SwerveSubsystem swerve) {
        timer = new Timer();
        this.swerve = swerve;
    ...
    public void execute() {
        ...
        swerve.drive(
            new Translation2d(0.5 * Constants.swerveSubsystem.kPositionOneYCF, -0.5 * Constants.swerveSubsystem.kPositionOneYCF),
            0.0,
            false);
    }
    @Override
